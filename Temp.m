...
dilationAmount = 5;
rad = floor(dilationAmount); [r,c] = size(tumor);
...
subplot(2,3,1);title('Input image','FontSize',20);
subplot(2,3,2);title('Filtered image','FontSize',20);
subplot(2,3,3);title('Bounding Box','FontSize',20);
subplot(2,3,4);title('Tumor alone','FontSize',20);
subplot(2,3,5);title('Tumor Outline','FontSize',20);
subplot(2,3,6);title('Detected Tumor','FontSize',20);
subplot(2,3,2);imshow(inp);title('Filtered image','FontSize',20);
subplot(2,3,3);imshow(inp);title('Bounding Box','FontSize',20);
hold on;rectangle('Position',wantedBox,'EdgeColor','y');
hold off; subplot(2,3,4);imshow(tumor);title('Tumor alone','FontSize',20);
